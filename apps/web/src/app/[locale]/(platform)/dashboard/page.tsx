  ...
  if (data.isLoading) {
    return (
      <div className="space-y-8" aria-hidden="true">
        {/* Title */}
        <div className="h-9 w-48 animate-pulse rounded bg-[var(--input)]" />
          ...
          <div className="dash-top">
            <div className="dash-identity">
              ...
              <div className="space-y-2">
                <div className="h-8 w-24 animate-pulse rounded bg-[var(--input)]" />
                <div className="h-3 w-32 animate-pulse rounded bg-[var(--input)]" />
                <div className="h-2 w-40 animate-pulse rounded-full bg-[var(--input)]" />
              </div>
            </div>
            <div className="flex flex-wrap gap-3">
              {Array.from({ length: 6 }).map((_, i) => (
                <div key={i} className="flex flex-col items-center gap-1">
                  <div className="h-10 w-10 animate-pulse rounded-lg bg-[var(--input)]" />
                  <div className="h-2 w-8 animate-pulse rounded bg-[var(--input)]" />
                </div>
              ))}
            </div>
          </div>
          <div className="dash-bottom">
            <div className="h-32 w-full animate-pulse rounded bg-[var(--input)]" />
          </div>
        </div>
        ...
        <section className="cc-section">
          <div className="cc-section-head">
            <div className="h-6 w-36 animate-pulse rounded bg-[var(--input)]" />
          </div>
          <div className="cc-grid">
            {Array.from({ length: 2 }).map((_, i) => (
              <div key={i} className="cc-card">
                <div className="cc-thumb">
                  <div className="h-full w-full animate-pulse bg-[var(--input)]" />
                </div>
                <div className="cc-body">
                  <div className="space-y-2">
                    <div className="h-4 w-3/4 animate-pulse rounded bg-[var(--input)]" />
                    <div className="h-3 w-1/2 animate-pulse rounded bg-[var(--input)]" />
                  </div>
                </div>
              </div>
            ))}
              ...
              {Array.from({ length: 4 }).map((_, i) => (
                <div key={i} className="act-row">
                  <div className="act-left">
                    <div className="h-8 w-8 animate-pulse rounded-lg bg-[var(--input)]" />
                    <div className="h-3 w-48 animate-pulse rounded bg-[var(--input)]" />
                  </div>
